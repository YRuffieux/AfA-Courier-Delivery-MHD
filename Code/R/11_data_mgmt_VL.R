...
DTbas_untested <- DTbas[!DTrna,on="patient"]         # dataset with indiviudals having no LV test during follow-up
...
if(courier_lag==0)
{
  ...
  save(DTbas_untested,file=file.path(filepath_processed,"AfA_VL_untested.RData"))
} else
{
